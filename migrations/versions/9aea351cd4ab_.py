...
Revision ID: 9aea351cd4ab
Revises: c8dd15f0588a
Create Date: 2019-02-14 16:23:52.199333
...
revision = '9aea351cd4ab'
down_revision = 'c8dd15f0588a'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('director', sa.String(length=40), nullable=True),
    ...
    sa.Column('screeningmodel', sa.String(length=40), nullable=True),
